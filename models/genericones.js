...
module.exports = (sequelize, DataTypes) => {
  ...
  const Genericones = sequelize.define('genericones', {
    id: {
      type: DataTypes.INTEGER,
      defaultValue: Sequelize.literal('nextval(genericones_id_seq::regclass)'),
    },
    firstname: {

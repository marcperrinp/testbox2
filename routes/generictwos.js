...
const { generictwos } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('generictwos');

// This file contains the logic of every route in Forest Admin for the collection generictwos:
...
// Create a Generictwo
router.post('/generictwos', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Generictwo
router.put('/generictwos/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Generictwo
router.delete('/generictwos/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Generictwos
router.get('/generictwos', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Generictwos
router.get('/generictwos/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Generictwo
router.get('/generictwos/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Generictwos
router.get('/generictwos.csv', permissionMiddlewareCreator.export(), (request, response, next) => {

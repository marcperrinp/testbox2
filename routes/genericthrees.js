...
const { genericthrees } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('genericthrees');

// This file contains the logic of every route in Forest Admin for the collection genericthrees:
...
// Create a Genericthree
router.post('/genericthrees', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Genericthree
router.put('/genericthrees/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Genericthree
router.delete('/genericthrees/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Genericthrees
router.get('/genericthrees', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Genericthrees
router.get('/genericthrees/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Genericthree
router.get('/genericthrees/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Genericthrees
router.get('/genericthrees.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
